...
def create_vgg_ssd(num_classes, is_test=False):
    ...
    regression_poses = ModuleList([
        Conv2d(in_channels=512, out_channels=4 * 3, kernel_size=3, padding=1),
        Conv2d(in_channels=1024, out_channels=6 * 3, kernel_size=3, padding=1),
        Conv2d(in_channels=512, out_channels=6 * 3, kernel_size=3, padding=1),
        Conv2d(in_channels=256, out_channels=6 * 3, kernel_size=3, padding=1),
        Conv2d(in_channels=256, out_channels=4 * 3, kernel_size=3, padding=1),
        Conv2d(in_channels=256, out_channels=4 * 3, kernel_size=3, padding=1), # TODO: change to kernel_size=1, padding=0?
    ])
