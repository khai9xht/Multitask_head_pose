...
def create_mobilenetv3_large_ssd_lite(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False):
    ...
    regression_poses = ModuleList([
        SeperableConv2d(in_channels=round(112 * width_mult), out_channels=6 * 3, kernel_size=3, padding=1, onnx_compatible=False),
        SeperableConv2d(in_channels=960, out_channels=6 * 3, kernel_size=3, padding=1, onnx_compatible=False),
