...
def create_mobilenetv1_ssd_lite(num_classes, is_test=False):
    ...
    regression_poses = ModuleList([
        SeperableConv2d(in_channels=512, out_channels=6 * 3, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=1024, out_channels=6 * 3, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=512, out_channels=6 * 3, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=256, out_channels=6 * 3, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=256, out_channels=6 * 3, kernel_size=3, padding=1),
        Conv2d(in_channels=256, out_channels=6 * 3, kernel_size=1),
    ])
