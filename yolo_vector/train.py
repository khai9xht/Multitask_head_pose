...
def fit_ont_epoch(net, yolo_losses, optimizer, epoch, epoch_size, 
            ...
            for i in range(3):
                ...
                if epoch < 25 or mode == "freeze":
                    ...
                    if writer != None:
                        ...
                        writer.add_scalar(f"{mode}_backbone/Loss_ortho", all_loss["ortho"], idx) 
    ...
    logs_train = "/content/drive/MyDrive/yolo_linear/Multitask_head_pose/yolo_vector/logs"
...
if __name__ == "__main__":
    ...
    annotation_path = "/content/data/resized_data/CMU_trainval.txt"
    model = YoloBody(Config)
    logTensorBoard_dir = "/content/drive/MyDrive/yolo_linear/Multitask_head_pose/yolo_vector/runs"
    ...
    # -------------------------------------------#
    pre_trained = "/content/drive/MyDrive/yolo_linear/Multitask_head_pose/yolo_vector/logs/unfreezeBackbone_Epoch50-Total_Loss668.5147-Val_Loss667.4742.pth"
    ...
    if Init_Epoch < Freeze_Epoch:
        ...
        Batch_size = 64
        lr_scheduler = optim.lr_scheduler.StepLR(f_optimizer, step_size=3, gamma=0.95)
